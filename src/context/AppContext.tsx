  ...
  const addEntry = async (entryData: Omit<Entry, 'id' | 'createdAt' | 'status' | 'pointsAwarded' | 'userName' | 'tripTitle'>): Promise<{ 
    ...
    const result = await submitEntryLogic(
      ...
      currentTrip as any,
      {
        ...
        deckId: submissionDeckId || undefined,
        deckName: (entryData as any).deckName || (currentTrip as any).deckName || submissionPack?.deckName || submissionPack?.packName,
        deckSubtitle: (entryData as any).deckSubtitle || (currentTrip as any).deckSubtitle || submissionPack?.deckSubtitle,
        cardType: (entryData as any).cardType || (currentTrip as any).cardType,
